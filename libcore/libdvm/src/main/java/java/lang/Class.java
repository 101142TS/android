...
public final class Class<T> implements Serializable, AnnotatedElement, GenericDeclaration, Type {
    ...
    //added start
    public static native Method[] spGetMethods();
    //added end
    ...
    // @101142ts
    public T exnewInstance() throws InstantiationException, IllegalAccessException {
        return exnewInstanceImpl();
    }

    private native T exnewInstanceImpl() throws IllegalAccessException, InstantiationException;
    // @101142ts, end
    @Override
