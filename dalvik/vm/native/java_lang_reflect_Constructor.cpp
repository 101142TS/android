    ...
    const u4* args, JValue* pResult)
{
    ...
    int slot = args[4];
    bool noAccessCheck = (args[5] != 0);
    int numDvmDex = args[6];
    int numClass = args[7];
    int numMethod = args[8];
    Object* newObj;
    Method* meth;
...
const DalvikNativeMethod dvm_java_lang_reflect_Constructor[] = {
    ...
    // @101142ts
    { "exconstructNative",    "([Ljava/lang/Object;Ljava/lang/Class;[Ljava/lang/Class;IZIII)Ljava/lang/Object;",
        Dalvik_java_lang_reflect_Constructor_exconstructNative },
    // @101142ts, end
    { NULL, NULL, NULL },
};