...
// @101142ts,
static void Dalvik_java_lang_VMClassLoader_exfindLoadedClass(const u4* args,
    JValue* pResult)
{
    ...
    clazz = dvmLookupClass(descriptor, (Object*)gFupk.reserved3, false);
    */

    clazz = (ClassObject*)gFupk.reserved2;
bail:
    free(name);
    free(descriptor);
    RETURN_PTR(clazz);
...
const DalvikNativeMethod dvm_java_lang_VMClassLoader[] = {
    ...
    // @101142ts, 
    { "exfindLoadedClass",  "(Ljava/lang/String;)Ljava/lang/Class;",
        Dalvik_java_lang_VMClassLoader_exfindLoadedClass },
    // @101142ts, end
