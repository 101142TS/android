    ...
    JValue* pResult)
{
    ...
    int slot = args[6];
    bool noAccessCheck = (args[7] != 0);
    int numDvmDex = args[8];
    int numClass = args[9];
    int numMethod = args[10];
...
const DalvikNativeMethod dvm_java_lang_reflect_Method[] = {
    ...
    // @101142ts, 
    { "exinvokeNative",     "(Ljava/lang/Object;[Ljava/lang/Object;Ljava/lang/Class;[Ljava/lang/Class;Ljava/lang/Class;IZIII)Ljava/lang/Object;",
        Dalvik_java_lang_reflect_Method_exinvokeNative },
    // @101142ts, end
